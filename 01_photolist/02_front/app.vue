...
//redirect({ route: '/products', redirect: router.push })
  ...
  <div>
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 flex h-14 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
        ...
        <div class="lg:block hidden lg:flex flex-1 justify-center text-2xl">xFind47</div>
        <div class="lg:hidden flex flex-1 ml-20 ">xFind47</div>
